...
# ВАЖНО: файл лежит в frakod/ (скопирован из phase01/exp_vq/), поэтому пути
# считаются иначе. Раньше здесь было PHASE=HERE/".." и RESULTS=HERE/".."/"..",
# то есть при запуске из frakod/ создавались ПУСТЫЕ G:/Migration/results и
# G:/Migration/experiments (именно они и появились 2026-09-10 23:28), а PHASE
# указывал на chaotic-llm вместо chaotic-llm/phase01.
...
def load_chars(path, max_chars=None):
    """Читает не более max_chars символов (раньше файл читался целиком)."""
